...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      item.closest('.popup-design') ? api = path.desiner : api = path.question; // якщо при відправленні форми, форма має батьківський елемент .popup-design - path.desiner. АБО path.question
